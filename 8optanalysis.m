...
for i = 1:length(subject_ids)
    ...
    ef_file = fullfile(opt_base, ['optimization_' subj], ...
    ...
    % Divide all EF values by 2
    EF_intensity = EF_image.vol / 2;
...
output_file = fullfile('D:\MATLAB\redoopt3', 'simulation_analysis_div2.xlsx');
try
    writetable(results, output_file);
    fprintf('\n✔ EF data (divided by 2) saved to Excel: %s\n', output_file);
catch ME
